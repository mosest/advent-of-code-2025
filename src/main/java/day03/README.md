...
| **Trip-Ups**    | Tried to just find the two biggest numbers at the beginning, then create the number using indices. <br><br>\*Mutombo finger wag\* Wastl said, not in my house. |            |
