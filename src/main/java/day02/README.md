...
| **Fun**         | ⭐⭐⭐⭐⚪                                                                                                        | ⭐⚪⚪⚪⚪                                                                                                                                            |
| **Description** | Find the numbers made up ONLY of one set of digits, repeated EXACTLY twice. <br><br>No other digits allowed. | Find the numbers made up ONLY of some sequence of digits, repeated ANY number of times.                                                          |
| **Method**      | 🎄 Substrings                                                                                                | 🎄                                                                                                                                               |
| **Trip-Ups**    |                                                                                                              |                                                                                                                                                  |
